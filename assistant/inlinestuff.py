...
from pyTheKillpro.functions.misc import google_search
from pyTheKillpro.functions.tools import async_searcher, dloader, get_ofox
...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/TeamTheKillpro/TheKillpro"),
        Button.url("• Support •", url="t.me/thekillpro"),
    ],
]

ofox = "https://telegra.ph/file/231f0049fcd722824f13b.jpg"
gugirl = "https://telegra.ph/file/0df54ae4541abca96aa11.jpg"
ultpic = "https://telegra.ph//file/5ae7b3dc82e6fea08a132.jpg"
...
async def repo(e):
    res = [
        await e.builder.article(
            title="TheKillPro-UserBot",
            description="Userbot | Telethon",
            thumb=wb(ultpic, 0, "image/jpeg", []),
            text="• **TheKillPro-UserBot** •",
            buttons=SUP_BUTTONS,
        ),
    ]
    await e.answer(res, switch_pm="TheKillpro Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://telegra.ph/TheKillpro-09-01-6)',
        )
